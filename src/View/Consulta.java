...
public class Consulta extends javax.swing.JFrame {
    ...
    private ProConsultaController procontroller;
    int id;
    ...
    public Consulta(int i) throws SQLException {
        ...
        procontroller = new ProConsultaController(this);
        iniciar();
    ...
    private void initComponents() {
        ...
        jTextConsultaPro = new javax.swing.JTextField();
        ...
        jTableProduto.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Descrição", "Categoria", "Preço", "Product", "Material", "Fornecedor"
            }
        ));
        ...
        jTextConsultaPro.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jTextConsultaPro.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextConsultaPro.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        jTextConsultaPro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextConsultaProActionPerformed(evt);
            }
        });
        jTextConsultaPro.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTextConsultaProKeyPressed(evt);
            }
        });
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(jTextConsultaPro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        }
    ...
    private void jTextConsultaProActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextConsultaProActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextConsultaProActionPerformed

    private void jTableProdutoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableProdutoMouseClicked
         try {
            procontroller.carregaDados();
            this.dispose();
             } catch (SQLException ex) {
            Logger.getLogger(Consulta.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jTextConsultaProKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextConsultaProKeyPressed
        jTextConsultaPro.getDocument().addDocumentListener(new DocumentListener(){
         @Override
            public void insertUpdate(DocumentEvent e) {
                String texto = (jTextConsultaPro.getText());
                if (texto != ""){
                 onTextChange(texto);
                } else 
                 try {
            ...
            private void onTextChange(String texto) {
                procontroller.ProcurarPorNome(texto);
                
            }

             private void onTextNull() throws SQLException {
                   procontroller.atualizaTabela();
             }
        
        });
    }//GEN-LAST:event_jTextConsultaProKeyPressed
    ...
    private javax.swing.JTextField jTextConsultaPro;
    ...
    private void iniciar() throws SQLException {
        ...
        this.procontroller.atualizaTabela();
    }
